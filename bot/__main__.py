...
def start(update, context):
    ...
    buttons.buildbutton("👥 Leech Grupu", "https://t.me/LeechGrupu")
    buttons.buildbutton("🎦 Kanal ", "https://t.me/TuranMovies")
...
'''
        ...
        sendMarkup(
            'Vay be! Botu Kullanma Yetkiniz Yok.\n Lütfen Grupa Katılın  <b>Leech Grupu ⚡</b>.',
            context.bot,
            update,
            reply_markup,
        )
